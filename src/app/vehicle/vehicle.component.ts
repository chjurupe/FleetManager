...
export interface VehicleElement {
  ...
  organization: string;
  order: Array<any>;
  vehicleAttachment: Array<any>;       
  vehicleMeter: Array<any>; 
  vehicleTask: Array<any>;              
}

const VEHICLE_DATA: VehicleElement[] =
[  
  {  
     "id":2,
